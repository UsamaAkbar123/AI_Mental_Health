...
import 'package:freud_ai/screens/interest/select_interest_page.dart';
import 'package:freud_ai/screens/questions/feature/model_view_model.dart';
import 'package:lottie/lottie.dart';

class InterestsOnboardingPage extends StatelessWidget {
  final FeatureViewModel? featureViewModel;

  const InterestsOnboardingPage({super.key, this.featureViewModel});
                ...
                child: featureViewModel!.isAnimationFill!
                    ...
                    : Stack(
                        children: [
                          ...
                          Lottie.asset(featureViewModel!.animation!).centralized()
                        ],
                      ),
              ),
            ),
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              ...
              Navigate.pushNamed(
                SelectInterestPage(
                    parentFeatureName: featureViewModel.parentFeatureName,
                    listOfQuestionsWidgets: featureViewModel.listOfWidgets),
              );
