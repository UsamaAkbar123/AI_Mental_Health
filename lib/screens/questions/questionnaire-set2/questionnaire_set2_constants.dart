...
class QuestionnaireSet2Constants {
  ...
  FeatureViewModel getFeature1Questions() {
    ...
    listOfPageWidgets
        .add(StressImpactQuestion(questionsModel: listedQuestionsModel2,key: UniqueKey()));
    ...
    listOfPageWidgets.add(
        QuestionsView(questionsModel: listedQuestionsModel3, isShowGrid: true,key: UniqueKey()));
  ...
  FeatureViewModel getFeature2Questions() {
    ...
    listOfPageWidgets.add(SleepQualityQuestion(selectedGoal: Constants.goal2Key,featureName: questionsFeature2,key: UniqueKey()));
  ...
  FeatureViewModel getFeature3Questions() {
    ...
    listOfPageWidgets.add(StepsTargetQuestion(selectedGoal: Constants.goal2Key,featureName: questionsFeature3,key: UniqueKey()));
