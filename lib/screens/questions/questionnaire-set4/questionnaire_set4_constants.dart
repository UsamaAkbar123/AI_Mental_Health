...
class QuestionnaireSet4Constants {
  ...
  FeatureViewModel getFeature1Questions() {
    ...
    listOfPageWidgets.add(
        QuestionsView(questionsModel: listedQuestionsModel1, isShowGrid: true,key: UniqueKey()));
    ...
    listOfPageWidgets.add(SleepQualityQuestion(selectedGoal: Constants.goal4Key,featureName: questionsFeature1,key: UniqueKey()));
  ...
  FeatureViewModel getFeature2Questions() {
    ...
    listOfPageWidgets.add(QuestionsView(questionsModel: listedQuestionsModel1,key: UniqueKey()));
    ...
    listOfPageWidgets
        .add(StressImpactQuestion(questionsModel: listedQuestionsModel3,key: UniqueKey()));
    ...
    listOfPageWidgets.add(QuestionsView(questionsModel: listedQuestionsModel2,key: UniqueKey()));
  ...
  FeatureViewModel getFeature3Questions() {
    ...
    listOfPageWidgets.add(QuestionsView(questionsModel: listedQuestionsModel3,key: UniqueKey()));



    listOfPageWidgets.add(StepsTargetQuestion(selectedGoal: Constants.goal4Key,featureName: questionsFeature3,key: UniqueKey()));
  ...
  FeatureViewModel getFeature4Questions() {
    ...
    listOfPageWidgets
        .add(SelectFromSliderQuestion(questionsModel: listedQuestionsModel,key: UniqueKey()));
